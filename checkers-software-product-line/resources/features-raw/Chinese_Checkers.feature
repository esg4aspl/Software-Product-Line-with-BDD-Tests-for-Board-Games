Feature: Chinese Checkers
  ...
  Scenario Outline: Player Chooses to Continue or Not
    ...
    Examples: 
      ...
      | playerChoosesToContinueOrNot2 |                 2 | stop      | next             |
  ...
  Scenario Outline: End of the Game In Draw
    ...
    Examples: 
      | file_name           | number_of_players | offer_response | result                                     |
      | endOfTheGameInDraw1 |                 2 | accepts        | the game is ended as a draw                |
      | endOfTheGameInDraw2 |                 2 | rejects        | the next turn is given to the other player |
      | endOfTheGameInDraw3 |                 2 | accepts        | the game is ended as a draw                |
      | endOfTheGameInDraw4 |                 2 | accepts        | the game is ended as a draw                |
      | endOfTheGameInDraw5 |                 2 | rejects        | the next turn is given to the other player |
