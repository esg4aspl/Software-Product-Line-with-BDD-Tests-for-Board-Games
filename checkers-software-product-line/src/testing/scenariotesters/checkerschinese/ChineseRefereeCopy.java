...
public class ChineseRefereeCopy extends AbstractReferee {
	protected ChineseCheckersBoardConsoleViewCopy consoleView;
	private String[] icons; 
	private Direction[] directions;
	IView view;

	public ChineseRefereeCopy(IGameConfiguration checkersGameConfiguration) {
	...
	private void setupBoardMVC() {
		...
		consoleView = new ChineseCheckersBoardConsoleViewCopy(this);
		view = new ChineseCheckersBoardConsoleViewCopy(this);
	}

	private void setupPiecesOnBoard() {
		icons = new String[]{"W","B","X","M","R","K"};
